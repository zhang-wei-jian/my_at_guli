  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <button @click="open" class="btn" to="/paysuccess">立即支付</button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
...
export default {
  ...
  methods: {
    async getPayInfo() {
      const res = await this.$api.reqPay(this.orderId);
      if (res.code === 200) {
    ...
    async open() {
      //转换支付链接图片
      const imgUrl = await QRCode.toDataURL(this.payInfo.codeUrl); //把某个字符串转换成图片路径
      //弹窗
