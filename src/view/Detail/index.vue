          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  v-for="itemDetall in item.spuSaleAttrValueList"
                  :key="itemDetall.id"
                  changepirce="0"
                  :class="{ active: Number(itemDetall.isChecked) }"
                  @click="handleChecked(itemDetall,item.spuSaleAttrValueList)"
                >
                  {{ itemDetall.saleAttrValueName }}
                </dd>
              </dl>
              <!-- <dl>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      gooodsDetail: (state) => state.detail.gooodsDetail,
    }),
    skuImageList() {
  ...
  methods: {
    ...
    handleChecked(checkItem,list) {
      // console.log(e.target);
      list.forEach(item=>item.isChecked=0)
   checkItem.isChecked = 1
